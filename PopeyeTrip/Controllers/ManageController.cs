    ...
    public class ManageController : BaseController
    {
        ...
        public ActionResult ChangeUserInfo()
        {
            ...
            ExternalLoginConfirmationViewModel model = new ExternalLoginConfirmationViewModel
            {
                ...
                AgreePhoneNumber = user.AgreePhoneNumber
            };
            return View(model);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangeUserInfo(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                var user = UserManager.FindById(User.Identity.GetUserId());

                user.ExternalType = model.ExternalType;
                user.Email = model.Email;
                user.AgreeEmail = model.AgreeEmail;
                ...
                user.AgreePhoneNumber = model.AgreePhoneNumber;
